...
struct stack* stack_create() {
	...
	stack->list = list_create(); //This function allocates and initializes a new, 
	// empty linked list and returns a pointer to it.
	return stack;
}
